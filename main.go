...
var SERVICENAME = flag.String("service", "PPLbypass", "Name of the service")
...
var DUMPNAME = flag.String("dumpname", "PPLbypass.dmp", "Name of the dump file")
var DUMPOBF = flag.Bool("obfuscate", false, "Obfuscate dump file")
var OBFKEY = flag.String("key", "PPLbypass", "XOR Key for obfuscation")
